...
const ListingDisplay = ({ listingData, toggleShareModal }) => {
  return (
    <div className="headerNav">
      <div id="hnListingDisplay">
        <div className="hnBodyContainer">
          <div className="hnTitleColumn">
            <svg className="hnTitleSvg" viewBox="0 0 66 34">
            ...
            <div className="hnListingTitleBox">
              <span id="listingTitle" className="hnListingTitle">{listingData.title}</span>
            </div>
          </div>
          <div className="hnImageColumn">
            <img src={listingData.listingPhoto} className="hnListingImage" />
            <div
              className="hnListingImageBox"
              id="listingPhotoBox"
              listingPhoto={listingData.listingPhoto}
            >
              <div className="hnButtonContainer">
                <button
                  className="hnShareButton"
                  id="shareModalButton"
                  onClick={() => toggleShareModal()}
                >
                  <span className="hnShareSpan">
                    <svg className="hnShareSvg" viewBox="0 0 24 24">
