...
const ShareModalBody = (props) => {
  ...
  return (
    <div className="headerNav">
      <div id="hnShareModalBody">
        <div className="hnModalBody">
          <GlobalStyle />
          <div className="hnTitle">Share</div>
          <div className="hnSubTitle">Check out this awesome listing on Airbnb: Immaculate Architect's Garden Townhouse.</div>
          <hr />
          <section className="hnSection">
            <div className="hnBox">
              <svg className="hnSvgBox" viewBox="0 0 32 32">
                <path d="m8 14.41v-4.17c0-.42.35-.81.77-.81h2.52v-2.08c0-4.84 2.48-7.31 7.42-7.35 1.65 0 3.22.21 4.69.64.46.14.63.42.6.88l-.56 4.06c-.04.18-.14.35-.32.53-.21.11-.42.18-.63.14-.88-.25-1.78-.35-2.8-.35-1.4 0-1.61.28-1.61 1.73v1.8h4.52c.42 0 .81.42.81.88l-.35 4.17c0 .42-.35.71-.77.71h-4.21v16c0 .42-.35.81-.77.81h-5.21c-.42 0-.8-.39-.8-.81v-16h-2.52a.78.78 0 0 1 -.78-.78"></path>
              </svg>
              <div className="hnLinkName">Facebook</div>
            </div>
            <hr />
            <div className="hnBox">
              <svg className="hnSvgBox" viewBox="0 0 32 32">
              ...
              <div className="hnLinkName">Twitter</div>
            </div>
            <hr />
            <div className="hnBox">
              <svg className="hnSvgBox" viewBox="0 0 32 32">
              ...
              <div className="hnLinkName">Email</div>
            </div>
            <hr />
            <div className="hnBox">
              <svg className="hnSvgBox" viewBox="0 0 32 32">
              ...
              <div className="hnLinkName">Messenger</div>
            </div>
            <hr />
            <div className="hnBox">
              <svg className="hnSvgBox" viewBox="0 0 32 32">
              ...
              <div className="hnLinkName">Copy Link</div>
            </div>
            <hr />
            <div className="hnBox">
              <svg className="hnSvgBox" viewBox="0 0 32 32">
              ...
              <div className="hnLinkName">Embeded</div>
            </div>
            <hr />
          </section>
        </div>
