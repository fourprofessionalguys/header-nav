...
const BookingFixed = ({ listingData }) => {
  ...
  return (
    <div className="headerNav">
      <div id="hnBookingFixed">
        <div className="hnFixedBottom">
          <div className="hnBodyContainer">
            <div className="fhnlexedBoxLeft">
              ...
              <div className="hnNameRatingBox">
                <div className="hnNameBox" id="listingType">
                  Entire {listingData.type}
                </div>
                <div className="hnRatingBox">
                  <Stars starCount={5} />
                </div>
              </div>
            </div>
            <div className="hnFlexedBox">
              <p className="hnPriceContainer" id="listingCost">
                <span className="hnPrice">${listingData.cost}</span> / night
              </p>
              <button className="hnBookButton">Book</button>
            </div>
          </div>
        </div>
      </div>
